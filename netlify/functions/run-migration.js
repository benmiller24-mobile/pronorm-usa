...
// netlify/functions/node_modules/postgres-array/index.js
var require_postgres_array = __commonJS({
  "netlify/functions/node_modules/postgres-array/index.js"(exports2) {
    "use strict";
...
// netlify/functions/node_modules/pg-types/lib/arrayParser.js
var require_arrayParser = __commonJS({
  "netlify/functions/node_modules/pg-types/lib/arrayParser.js"(exports2, module2) {
...
// netlify/functions/node_modules/postgres-date/index.js
var require_postgres_date = __commonJS({
  "netlify/functions/node_modules/postgres-date/index.js"(exports2, module2) {
    "use strict";
...
// netlify/functions/node_modules/xtend/mutable.js
var require_mutable = __commonJS({
  "netlify/functions/node_modules/xtend/mutable.js"(exports2, module2) {
...
// netlify/functions/node_modules/postgres-interval/index.js
var require_postgres_interval = __commonJS({
  "netlify/functions/node_modules/postgres-interval/index.js"(exports2, module2) {
    "use strict";
...
// netlify/functions/node_modules/postgres-bytea/index.js
var require_postgres_bytea = __commonJS({
  "netlify/functions/node_modules/postgres-bytea/index.js"(exports2, module2) {
    "use strict";
...
// netlify/functions/node_modules/pg-types/lib/textParsers.js
var require_textParsers = __commonJS({
  "netlify/functions/node_modules/pg-types/lib/textParsers.js"(exports2, module2) {
    var array = require_postgres_array();
...
// netlify/functions/node_modules/pg-int8/index.js
var require_pg_int8 = __commonJS({
  "netlify/functions/node_modules/pg-int8/index.js"(exports2, module2) {
    "use strict";
    var BASE = 1e6;
...
// netlify/functions/node_modules/pg-types/lib/binaryParsers.js
var require_binaryParsers = __commonJS({
  "netlify/functions/node_modules/pg-types/lib/binaryParsers.js"(exports2, module2) {
...
// netlify/functions/node_modules/pg-types/lib/builtins.js
var require_builtins = __commonJS({
  "netlify/functions/node_modules/pg-types/lib/builtins.js"(exports2, module2) {
    module2.exports = {
      BOOL: 16,
      BYTEA: 17,
      CHAR: 18,
...
// netlify/functions/node_modules/pg-types/index.js
var require_pg_types = __commonJS({
  "netlify/functions/node_modules/pg-types/index.js"(exports2) {
...
// netlify/functions/node_modules/pg/lib/crypto/utils-legacy.js
var require_utils_legacy = __commonJS({
  "netlify/functions/node_modules/pg/lib/crypto/utils-legacy.js"(exports2, module2) {
    "use strict";
...
// netlify/functions/node_modules/pg/lib/crypto/utils-webcrypto.js
var require_utils_webcrypto = __commonJS({
  "netlify/functions/node_modules/pg/lib/crypto/utils-webcrypto.js"(exports2, module2) {
    var nodeCrypto = require("crypto");
    module2.exports = {
      postgresMd5PasswordHash,
      randomBytes,
...
// netlify/functions/node_modules/pg-cloudflare/dist/empty.js
var require_empty = __commonJS({
  "netlify/functions/node_modules/pg-cloudflare/dist/empty.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.default = {};
  }
...
// netlify/functions/node_modules/split2/index.js
var require_split2 = __commonJS({
  "netlify/functions/node_modules/split2/index.js"(exports2, module2) {
    "use strict";
...
exports.handler = async function(event) {
  ...
  for (const h of hosts) {
    try {
      ...
      connected = true;
      attempts.push("Connected via " + h.host);
      break;
    } catch (e) {
      attempts.push(h.host + ": " + e.message);
      try {
        await client.end();
      } catch {
      }
  ...
  if (!connected) {
    return {
      ...
      body: JSON.stringify({ error: "Could not connect", attempts }, null, 2)
    };
  }
  ...
  try {
    ...
    if (typeCheck.rows.length === 0) {
      ...
      if (valCheck.rows.length === 0) {
        ...
        steps.push("designer value exists");
      }
    }
    ...
    if (colCheck.rows.length === 0) {
      ...
      steps.push("parent_dealer_id exists");
    }
    try {
      await client.query("ALTER TABLE dealers DROP CONSTRAINT IF EXISTS dealers_role_check");
      steps.push("Dropped check constraint");
    } catch (e) {
      steps.push("No check constraint");
    }
    const policyDrops = [
      ["Projects: read own", "projects"],
      ["Projects: insert own", "projects"],
      ["Projects: update own", "projects"],
      ["Projects: elevated read all", "projects"],
      ["Projects: elevated update all", "projects"],
      ["Project files: read own", "project_files"],
      ["Project files: insert own", "project_files"],
      ["Project files: elevated read all", "project_files"],
      ["Project files: elevated insert all", "project_files"],
      ["Orders: read own", "orders"],
      ["Orders: update own", "orders"],
      ["Orders: admin read all", "orders"],
      ["Orders: admin update all", "orders"],
      ["Order files: read own", "order_files"],
      ["Order files: insert own", "order_files"],
      ["Order files: admin read all", "order_files"],
      ["Order files: admin insert all", "order_files"],
      ["Order updates: read own", "order_status_updates"],
      ["Order updates: admin read all", "order_status_updates"],
      ["Warranty: read own", "warranty_claims"],
      ["Warranty: insert own", "warranty_claims"],
      ["Warranty: admin read all", "warranty_claims"],
      ["Warranty files: read own", "warranty_files"],
      ["Warranty files: insert own", "warranty_files"],
      ["Warranty files: admin read all", "warranty_files"],
      ["Projects: read accessible", "projects"],
      ["Projects: insert accessible", "projects"],
      ["Projects: update accessible", "projects"],
      ["Project files: read accessible", "project_files"],
      ["Project files: insert accessible", "project_files"],
      ["Orders: read accessible", "orders"],
      ["Orders: update accessible", "orders"],
      ["Order files: read accessible", "order_files"],
      ["Order files: insert accessible", "order_files"],
      ["Order updates: read accessible", "order_status_updates"],
      ["Warranty: read accessible", "warranty_claims"],
      ["Warranty: insert accessible", "warranty_claims"],
      ["Warranty files: read accessible", "warranty_files"],
      ["Warranty files: insert accessible", "warranty_files"]
    ];
    ...
    const tables = await client.query("SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name IN ('projects','project_files','orders','order_files','order_status_updates','warranty_claims','warranty_files')");
    const existing = tables.rows.map((r) => r.table_name);
    steps.push("Tables: " + existing.join(", "));
    const pol = (name, table, op, check, using) => {
      if (!existing.includes(table)) return;
      const sql = op === "INSERT" ? `CREATE POLICY "${name}" ON ${table} FOR INSERT WITH CHECK (${check})` : `CREATE POLICY "${name}" ON ${table} FOR ${op} USING (${using})`;
      return client.query(sql);
    };
    const dealerCheck = (tbl, fk = "dealer_id") => `EXISTS (SELECT 1 FROM dealers d WHERE d.user_id = auth.uid() AND (d.role = 'admin' OR d.id = ${tbl}.${fk} OR d.parent_dealer_id = ${tbl}.${fk}))`;
    const joinCheck = (joinTbl, joinCol, fk = "dealer_id") => `EXISTS (SELECT 1 FROM ${joinTbl} j JOIN dealers d ON d.user_id = auth.uid() WHERE j.id = %TABLE%.${joinCol} AND (d.role = 'admin' OR d.id = j.${fk} OR d.parent_dealer_id = j.${fk}))`;
    if (existing.includes("projects")) {
      const c = dealerCheck("projects");
      await pol("Projects: read accessible", "projects", "SELECT", null, c);
      await pol("Projects: insert accessible", "projects", "INSERT", c);
      await pol("Projects: update accessible", "projects", "UPDATE", null, c);
    ...
    if (existing.includes("project_files")) {
      ...
      await pol("Project files: read accessible", "project_files", "SELECT", null, c);
      await pol("Project files: insert accessible", "project_files", "INSERT", c);
      steps.push("Project files policies OK");
    }
    if (existing.includes("orders")) {
      const c = dealerCheck("orders");
      await pol("Orders: read accessible", "orders", "SELECT", null, c);
      await pol("Orders: update accessible", "orders", "UPDATE", null, c);
    ...
    if (existing.includes("order_files")) {
      ...
      await pol("Order files: read accessible", "order_files", "SELECT", null, c);
      await pol("Order files: insert accessible", "order_files", "INSERT", c);
    ...
    if (existing.includes("order_status_updates")) {
      ...
      await pol("Order updates: read accessible", "order_status_updates", "SELECT", null, c);
      steps.push("Order updates policy OK");
    }
    if (existing.includes("warranty_claims")) {
      const c = dealerCheck("warranty_claims");
      await pol("Warranty: read accessible", "warranty_claims", "SELECT", null, c);
      await pol("Warranty: insert accessible", "warranty_claims", "INSERT", c);
    ...
    if (existing.includes("warranty_files")) {
      ...
      await pol("Warranty files: read accessible", "warranty_files", "SELECT", null, c);
      await pol("Warranty files: insert accessible", "warranty_files", "INSERT", c);
    ...
    if (dealerRow.rows.length) {
      ...
      steps.push("Designer linked to parent");
    }
    ...
    return {
      statusCode: 200,
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ summary: "Migration complete!", steps, dealers: final.rows }, null, 2)
    };
  } catch (err) {
    try {
      await client.end();
    ...
    return {
      statusCode: 500,
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ error: err.message, steps, stack: err.stack }, null, 2)
    };
  }
};
