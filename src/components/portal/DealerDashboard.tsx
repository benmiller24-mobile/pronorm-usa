...
export default function DealerDashboard({ dealer, onNavigate }: DashboardProps) {
  ...
  const activeProjects = projects.filter(p => !['approved'].includes(p.status));
  ...
  if (loading) {
    return <div style={{ padding: '3rem', textAlign: 'center', color: '#8a8279' }}>Loading dashboard...</div>;
  }
    ...
    <div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{
          ...
          Welcome, {dealer.contact_name}
        </h1>
        <p style={{ fontSize: '0.88rem', color: '#8a8279', marginTop: '0.25rem' }}>
          {dealer.company_name} &mdash; Dealer Dashboard
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
        <div style={cardStyle}>
          <div style={statStyle}>{activeProjects.length}</div>
          <div style={{ fontSize: '0.78rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#4a4a4a', marginTop: '0.5rem' }}>Active Projects</div>
        </div>
        <div style={cardStyle}>
          <div style={statStyle}>{activeOrders.length}</div>
          <div style={{ fontSize: '0.78rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#4a4a4a', marginTop: '0.5rem' }}>Open Orders</div>
        </div>
        <div style={cardStyle}>
          <div style={statStyle}>{orders.filter(o => o.status === 'in_production').length}</div>
          <div style={{ fontSize: '0.78rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#4a4a4a', marginTop: '0.5rem' }}>In Production</div>
        </div>
        <div style={cardStyle}>
          <div style={statStyle}>{pendingWarranties.length}</div>
          <div style={{ fontSize: '0.78rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#4a4a4a', marginTop: '0.5rem' }}>Open Warranty Claims</div>
        </div>
      </div>
      ...
      <div style={{ ...cardStyle, marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          ...
          <button onClick={() => onNavigate('/dealer-portal/projects')} style={{
            background: 'none', border: 'none', color: '#b87333', fontSize: '0.75rem',
            fontWeight: 600, cursor: 'pointer', letterSpacing: '0.05em', textTransform: 'uppercase', fontFamily: 'inherit',
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid #e8e4df' }}>
                <th style={{ textAlign: 'left', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Job Name</th>
                <th style={{ textAlign: 'left', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Client</th>
                <th style={{ textAlign: 'left', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Status</th>
                <th style={{ textAlign: 'right', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Date</th>
              </tr>
            </thead>
            <tbody>
              {projects.map(p => (
      ...
      <div style={cardStyle}>
        ...
        {orders.length === 0 ? (
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid #e8e4df' }}>
                <th style={{ textAlign: 'left', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Order #</th>
                <th style={{ textAlign: 'left', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Status</th>
                <th style={{ textAlign: 'left', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Payment</th>
                <th style={{ textAlign: 'right', padding: '0.5rem 0', fontWeight: 600, color: '#4a4a4a', fontSize: '0.72rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Total</th>
              </tr>
            </thead>
            <tbody>
              {orders.map(o => (
