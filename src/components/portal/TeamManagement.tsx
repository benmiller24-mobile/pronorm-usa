  ...
  async function handleInvite(e: React.FormEvent) {
    ...
    try {
      ...
      const payload = {
        ...
        phone: form.phone,
        role: inviteRole,
        company_name: inviteRole === 'dealer' ? form.company_name : (form.company_name || undefined),
        address: inviteRole === 'dealer' ? form.address : (form.address || undefined),
        parent_dealer_id: inviteRole === 'designer' ? inviteParentId : undefined,
      };
