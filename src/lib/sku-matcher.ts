...
const TYPE_TO_CATEGORY: Record<string, string[]> = {
  ...
  'open_shelf': ['Wall units'],
  'extractor_unit': ['Wall units'],
...
const PREFIX_HINTS: Record<string, string[]> = {
  ...
  'OE': ['wall_unit', 'corner_wall', 'corner wall unit'],
  'OR': ['wall_unit', 'open_shelf', 'wall with flap door'],
  'OG': ['wall_unit', 'extractor_unit', 'wall for extractor', 'rangehood housing'],
